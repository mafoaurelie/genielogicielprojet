      ...
      <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
          <h4 class="d-flex justify-content-between align-items-center mb-3">
            <span class="text-muted">Images de la cité</span>
          </h4>
          <div id="carouselExampleControls" class="carousel slide" data-ride="carousel" >
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="{{ asset( $city->files()->get()[0]->path ) }}" alt="First slide" style="border-radius:4px">
                </div>
               @foreach( $city->files()->get() as $file )
        ...
        <div class="col-md-8 order-md-1">
          <h1 class="mb-3">Details de la cité</h1>
            <div class="text-mute">
                <h4>Description</h4>
                <p class="text-muted">
                    {{ $city->description }}
            ...
            <div class="text-mute">
                <h4>Nombre de chambres libres</h4>
                <p class="text-muted">
                    <b> {{ strtoupper($city->nbr_free_rooms ) }} chambres libres </b>
                </p>
            </div>
            <div class="text-mute">
                <h4>Prix </h4>
                <p class="text-muted">
                   Prix d'une chambre :<b> CFA {{ strtoupper($city->price_per_rooms) }} </b>
                </p>
            </div>
            <div class="text-mute">
                <h4> Tags associés </h4>
            ...
            <form class="form-check" method="post" action="/payment/store">
                ...
                <div class="col-md-6 mb-6">
                    ...
                    <input type="text" class="form-control" name="amount" id="amount" value="{{ $city->price_per_rooms }}" readonly>
