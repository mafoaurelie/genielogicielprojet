...
<!--/.nav-collapse -->
	...
	<header id="head">
		<div class="container">
			<div class="row">
				...
				<a href="/cities" class="btn btn-action btn-lg">chambres</a>
				<a class="btn btn-action btn-lg" role="button" href="/appartements">Appartements </a>
				<a class="btn btn-action btn-lg" role="button" href="">Studios </a>
			</div>
		</div>
	</header>
	<!-- /Header -->
	...
	<div class="container text-center">
		<br> <br>
		<h2 class="thin">Le meilleur site en matiere de presentation de logements dans la ville de Dschang.</h2>
		<p class="text-muted">
            ...
            logements dans la ville  de Dschang.Tout n'est que question de rapidité en informations.
						...
						@php ($i=0)
						<h2 class="thin"> Quelques chambres dans la ville de Dschang.</h2>

                  @foreach( App\City::where('statut','=',"accepter")->get() as $city)
				  		@php ($i=$i+1)
				  	@if($i<4)
						<div class="col-sm-4">
									<div class="card">
                  ...
                  @endforeach
				 	 @php ($i=0)
				 	 <h2 class="thin"> Quelques appartements dans la ville de Dschang.</h2>

                  @foreach( App\Apartment::where('statut','=',"accepter")->get() as $Apartment)
				  		@php ($i=$i+1)
				  	@if($i<4)
						<div class="col-sm-4">
									<div class="card">
				...
				<div class="row">
					...
					<div class="col-md-3 widget">
						...
						<div class="widget-body">
							<p>+234 23 9873237<br>
								<a href="mailto:#">jeanneaureli98@gmail.com</a><b           r>
								<br>
								234 
							</p>	
						</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 widget">
						<div class="widget-body">
							<p class="text-right">
								Copyright &copy; 2021, Your name. Designed by <a href="http://gettemplate.com/" rel="designer"></a> 
							</p>
						</div>
					</div>
